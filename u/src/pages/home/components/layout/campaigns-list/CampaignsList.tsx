                    ...
                    <tr key={item._id} className="home-campaigns-table__row">
                        <td className="home-campaigns-table__cell">
                            <div className="home-campaigns-table__status">
                                <img className="home-campaigns-table__icon" src={getSocialMediaIcon(item.socialMedia)}
                                     alt=""/>
                                <p>{item.status}</p>
                            </div>
                        </td>

                        <td className="home-campaigns-table__cell home-campaigns-table__date">{item.creationDate}</td>
                        <td className="home-campaigns-table__cell home-campaigns-table__name">{item.campaignName}</td>
                        <td className="home-campaigns-table__cell home-campaigns-table__price">{item.price}€</td>
                    </tr>
                ))}
                </tbody>
            </table>
