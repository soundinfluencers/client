...
export { CampaignDraftLatestStep } from "@/client-side/types/draft.types";
...
export type CampaignContentItem = {
  ...
  taggedUser: string;
  taggedLink: string;
  additionalBrief: string | Array<{ _id: string; additionalBrief: string }>;
  accountId?: string;
  profileType?: "creator" | "community";
  mediaCache?: any;
};
